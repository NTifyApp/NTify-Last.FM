...
public class libLanguage {
    ...
    public String translate(String key) {
        ...
        if (afl) {
            try {
                JSONObject object = new JSONObject(removeComment(IOUtils.toString(Objects.requireNonNull(Initiator.class.getResourceAsStream("/" + lf + "/" + languageCode + ".json")), Charset.defaultCharset())));
                object.toMap().forEach(new BiConsumer<String, Object>() {
                    @Override
                    public void accept(String s, Object o) {
                        if (s.equals(key)) {
